...
Встраивание структур. Агрегация и композиция структур и интерфейсов.

Выравнивание структур. Модель памяти: Стек и Куча. Escape Analysis.

Value / Pointer receiver у структур.
...
## Встраивание
Документация: https://go.dev/doc/effective_go#embedding

Как Go выполняет встраивание https://habr.com/ru/companies/vk/articles/686758/

## Value / Pointer receiver
Документация: https://go.dev/doc/effective_go#pointers_vs_values
